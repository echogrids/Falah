...
export const PRAYER_VISUALS: Record<string, { icon: LucideIcon; className: string }> = {
  ...
  asr: { icon: CloudSun, className: "bg-chart-4/20 text-chart-4 ring-1 ring-chart-4/30" },
  maghrib: { icon: Sunset, className: "bg-chart-2/20 text-chart-2 ring-1 ring-chart-2/30" },
  isha: { icon: MoonStar, className: "bg-chart-5/20 text-chart-5 ring-1 ring-chart-5/30" },
};
