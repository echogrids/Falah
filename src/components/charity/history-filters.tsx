...
const TYPE_FILTERS = [
  { value: "all", label: "All" },
  { value: "offer_created", label: "Offers" },
  { value: "donation_recorded", label: "Donations" },
  { value: "institution_created", label: "Institutions" },
] as const;
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="relative">
        ...
        <Input
          type="text"
          placeholder="Search institution or purpose..."
          value={search}
